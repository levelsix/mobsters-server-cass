...
import com.lvl6.mobsters.eventprotos.EventStaticDataProto.PurgeClientStaticDataResponseProto;
...
public class PurgeClientStaticDataResponseEvent extends NormalResponseEvent {
  ...
  public PurgeClientStaticDataResponseEvent(String playerId) {
    super(playerId);
    eventType = MobstersEventProtocolResponse.S_PURGE_STATIC_DATA_EVENT_VALUE;
  }
